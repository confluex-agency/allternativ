  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative min-h-[calc(100dvh-4rem)] md:min-h-[92vh] overflow-hidden">
        ...
        <div className="pointer-events-none absolute left-0 right-0 top-[37%] bottom-[38%] sm:portrait:top-[34%] sm:portrait:bottom-[24%] md:portrait:top-[34%] md:portrait:bottom-[12%] landscape:left-auto landscape:top-0 landscape:bottom-0 landscape:w-[48%] xl:landscape:w-[44%]">
          <HeroVideoLazy />
        </div>
